...
interface EarbudsContentProps {
    products: Product[];
}

export default function EarbudsContent({ products }: EarbudsContentProps) {
    ...
    if (!heroProduct) return (
        <div className="min-h-screen pt-32 flex flex-col items-center justify-center text-center">
            <h1 className="text-3xl font-bold mb-4">No Earbuds Found</h1>
            <Link href="/shop" className="text-zinc-500 hover:text-black underline">Back to Shop</Link>
        </div>
    );
    ...
    return (
        <main className="bg-white min-h-screen pt-28 md:pt-20 pb-12">
            <div className="md:hidden max-w-7xl mx-auto px-6 md:px-12 mb-8">
                <h1 className="text-3xl md:text-5xl font-bold text-zinc-900 tracking-tight">Earbuds</h1>
            </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                        ...
                        <div className="flex-1 space-y-8 order-2 lg:order-1">
                            ...
                            <p className="hero-content text-zinc-500 text-xl leading-relaxed max-w-lg">
                                {heroProduct.description}. Experience true wireless freedom with our signature audio technology.
                            </p>
