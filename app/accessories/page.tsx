...
export default function AccessoriesPage() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-white text-zinc-900 px-6">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">Accessories</h1>
            ...
            {status === "success" ? (
                ...
                <form onSubmit={handleSubmit} className="pt-4 mb-12 w-full max-w-md">
                    <div className="flex items-center bg-white rounded-full p-1.5 pl-6 shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-zinc-100 gap-4 transition-transform hover:scale-[1.02] duration-300 w-full">
                        <input
                            type="email"
                            ...
                            required
                            className="flex-1 bg-transparent outline-none text-zinc-900 placeholder:text-zinc-400 font-medium py-2"
                        />
                        <button
                            type="submit"
